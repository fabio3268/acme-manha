        ...
        <div class="row">
            <div class="col-lg-4 col-md-6 align-self-center">
                <div class="image-block bg-about">
                    <img class="img-fluid" src="<?= url("assets/web/"); ?>images/speakers/featured-speaker.jpg" alt="">
                </div>
            </div>
                            ...
                            <ul class="m-0 p-0">
                                ...
                                <li class="schedule-details">
                                    <div class="block">
                                        ...
                                        <!-- Speaker -->
                                        <div class="speaker">
                                            <img src="<?= url("assets/web/"); ?>images/speakers/speaker-thumb-one.jpg" alt="speaker-thumb-one">
                                ...
                                <li class="schedule-details">
                                    <div class="block">
                                        ...
                                        <!-- Speaker -->
                                        <div class="speaker">
                                            <img src="<?= url("assets/web/"); ?>images/speakers/speaker-thumb-two.jpg" alt="speaker-thumb-two">
                                ...
                                <li class="schedule-details">
                                    <div class="block">
                                        ...
                                        <!-- Speaker -->
                                        <div class="speaker">
                                            <img src="<?= url("assets/web/"); ?>images/speakers/speaker-thumb-three.jpg" alt="speaker-thumb-three">
                                ...
                                <li class="schedule-details">
                                    <div class="block">
                                        ...
                                        <!-- Speaker -->
                                        <div class="speaker">
                                            <img src="<?= url("assets/web/"); ?>images/speakers/speaker-thumb-four.jpg" alt="speaker-thumb-four">
                                ...
                                <li class="schedule-details">
                                    <div class="block">
                                        ...
                                        <!-- Speaker -->
                                        <div class="speaker">
                                            <img src="<?= url("assets/web/"); ?>images/speakers/speaker-thumb-five.jpg" alt="speaker-thumb-five">
                                ...
                                <li class="schedule-details">
                                    <div class="block">
                                        ...
                                        <!-- Speaker -->
                                        <div class="speaker">
                                            <img src="<?= url("assets/web/"); ?>images/speakers/speaker-thumb-six.jpg" alt="speaker-thumb-six">
                                            <span class="name">Lee Mun</span>
                                        </div>
                                        <!-- Subject -->
                                        <div class="subject">Useful tips for Wp</div>
